    ...
    <div className={cn("max-w-sm md:max-w-4xl mx-auto px-4 md:px-8 lg:px-12 py-20", className)}>
      <div className="relative grid grid-cols-1 md:grid-cols-2 gap-20">
              ...
              {testimonials.map((testimonial, index) => (
                ...
                >
                  <img // Changed from Image to img
                    ...
                    // Removed width and height props as they are not needed for img tag with h-full w-full
                    draggable={false}
        ...
        <div className="flex justify-between flex-col py-4">
          ...
          >
            <h3 className="font-serif text-xl font-extralight text-foreground">
              {testimonials[active].name}
            </h3>
            <p className="leading-normal tracking-tight text-sm text-muted-foreground">
              {testimonials[active].designation}
            </p>
            <motion.p className="leading-normal tracking-tight text-lg text-muted-foreground mt-8">
